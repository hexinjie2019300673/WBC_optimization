...
Eigen::Matrix<double, 19, 1> Car_arm::Solver_double()
{
    // 解决问题 car + left arm
    ...
    Eigen::Matrix<double, 10, 1> q_Base_Leffector;
    q_Base_Leffector << q_waist, q_left;
    Eigen::Matrix<double, 4, 4> T_Base_Leffector = Fkine(dh_list_Base_Leffector, q_Base_Leffector);

    Eigen::Matrix<double, 10, 1> q_Base_Reffector;
    q_Base_Reffector << q_waist, q_right;
    Eigen::Matrix<double, 4, 4> T_Base_Reffector = Fkine(dh_list_Base_Reffector, q_Base_Reffector);
    ...
    cout << "w_Reffector" << w_Reffector << endl;
    V_Carbase_Reffector_star = beta * V_Carbase_Reffector_star;
...
void Car_arm::Update_parameter_double(const Eigen::Matrix<double, 4, 4> &T_World_Carbase_input,
